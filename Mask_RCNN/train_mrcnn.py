...
trainset = CocoDetection(root='/home/work/daehyun/Photo-Editor/train2017', annFile='/home/work/daehyun/Photo-Editor/annotations/instances_train2017_adj.json', transforms=transforms)
trainset = datasets.wrap_dataset_for_transforms_v2(trainset, target_keys=("boxes", "labels", "masks"))


validset = CocoDetection(root='/home/work/daehyun/Photo-Editor/val2017', annFile='/home/work/daehyun/Photo-Editor/annotations/instances_val2017.json', transforms=transforms_test)
